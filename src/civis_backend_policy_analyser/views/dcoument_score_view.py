...
from civis_backend_policy_analyser.schemas.document_score_schema import DocumentScoreSchema, DocumentScoreOut, PromptScore
...
class DocumentScoreView(BaseView):
    ...
    async def score_assessment_area(self, document_id: str, assessment_id: int) -> List[DocumentScoreSchema]:
    ...
    async def format_result(
        ...
        max_score_total = 0
        # create a list of PromptScore objs
        prompt_records = []
